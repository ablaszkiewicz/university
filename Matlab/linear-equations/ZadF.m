...
plot(Ns, times);
title('Gauss-Seidel solve time');
xlabel('N');
ylabel('Time [s]');
saveas(gcf, "zadF_175715_0.png");

plot(Ns, iterations);
title('Gauss-Seidel iterations');
xlabel('N');
ylabel('Number of iterations');
saveas(gcf, "zadF_175715_1.png");

semilogy(norms, [1:length(norms)]);
title('Jacobi norms');
xlabel('N');
ylabel('Norm');
saveas(gcf, "zadF_175715_2.png");

plot(inversionTimes, Ns);
title('D+L inversion time');
xlabel('Size');
ylabel('Time [ms]');
saveas(gcf, "zadF_175715_3.png");